    ...
    <View style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.InputContainer}>
          ...
          >
            {/* 'Grit','Sohan','Crash Sand','Plaster Sand' */}
            <Picker.Item label="product" value="Phone" />
            <Picker.Item label="Earphones" value="Earphones" />
            <Picker.Item label="Iphone" value="Iphone" />
            <Picker.Item label="Android" value="Android" />
            <Picker.Item label="Laptop" value="Laptop" />
            <Picker.Item label="Camera" value="amera" />
            <Picker.Item label="Crash Sand Tech" value="Crash Sand Tech" />
            <Picker.Item label="Plaster phone" value="Plaster phone" />
          </Picker>
        </View>
        </View>
        <View style={styles.InputContainer}>
        ...
        <View style={styles.InputContainer}>
          ...
          >
            {/* 'Grit','Product','Crash Sand','Plaster Sand' */}
